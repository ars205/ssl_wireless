...
if __name__ == '__main__':
  ...
  for j in range(len(epochs_to_eval)):
    ...
    top_1, _ = classifier_knn(train_embeddings, train_spots[:,2:3].type(torch.long), test_embeddings, test_spots[:,2:3].type(torch.long), args.knn, 0.7, C_spots=args.c_spots)
