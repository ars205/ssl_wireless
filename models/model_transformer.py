...
class TransformerEncoder(nn.Module):
    ...
    def __init__(
        ...
        trunc_normal_(self.enc_lid_token, std=.02) 
        self.apply(self._init_weights)
...
class TransformerPooling(nn.Module):
    ...
    def forward(self, x, loca=False):
        ...
        if loca:
            ...
            sim_matrix = x_norm[:,matched_carriers] @ x_norm.unsqueeze(2).transpose(-2,-1)
    ...
    def subcarrier_matching(Num_slices, kk):
        ...
        # Stack the carrier locations along the first dimension
